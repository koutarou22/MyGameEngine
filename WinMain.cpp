...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInst, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    D3D11CreateDeviceAndSwapChain(
        ...
        &pSwapChain,				// 無事完成したSwapChainのアドレスが返ってくる　　←ここ重要
        &pDevice,				// 無事完成したDeviceアドレスが返ってくる　　　　　　←ここ重要
        &level,					// 無事完成したDevice、Contextのレベルが返ってくる
        &pContext);				// 無事完成したContextのアドレスが返ってくる　　　　←ここ重要
    ...
    while (msg.message != WM_QUIT)
    {
        ...
        else
        {
            ...
            //画面をクリア
            pContext->ClearRenderTargetView(pRenderTargetView, clearColor);//デバイスコンテキストの初仕事
    ...
    //解放処理　終わったらrelease　やってることはdeleteと同じ
